                ...
                <div className="space-y-2">
                  ...
                  {report.water_dist_before && report.water_dist_after && (() => {
                    ...
                    if (distGood && soldGood) {
                      ...
                      verdict = { label: 'ไม่มีการเปลี่ยนแปลง', sub: '', color: 'text-white/40 border-white/10 bg-white/5' }
                    }
                    ...
                    return (
                      <div className="rounded-xl border border-white/15 bg-white/5 p-4 space-y-3">
                        ...
                        <div className="flex items-center justify-between gap-2">
                          <p className="text-xs font-semibold text-white/50">สรุปแนวโน้ม</p>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className={`rounded-lg p-3 ${distGood ? 'bg-green-500/10 border border-green-500/20' : 'bg-red-500/10 border border-red-500/20'}`}>
                            <p className="text-xs text-white/50 mb-1">น้ำจ่าย</p>
                            ...
                            <p className="text-xs text-white/40 num mt-0.5">
                          ...
                          <div className={`rounded-lg p-3 ${soldGood ? 'bg-green-500/10 border border-green-500/20' : 'bg-red-500/10 border border-red-500/20'}`}>
                            <p className="text-xs text-white/50 mb-1">น้ำจำหน่าย</p>
