    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="glass-card p-6 space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-black/60 mb-1.5">ประเภทแผน</label>
          ...
          <div>
            <label className="block text-sm text-black/60 mb-1.5">ลำดับความสำคัญ</label>
        ...
        <div>
          <label className="block text-sm text-black/60 mb-1.5">กลุ่มแนวทาง</label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-black/60 mb-1.5">NRW Baseline (%)</label>
          ...
          <div>
            <label className="block text-sm text-black/60 mb-1.5">เป้าหมาย NRW (%)</label>
        ...
        <div>
          <label className="block text-sm text-black/60 mb-1.5">แผนการดำเนินการ</label>
        ...
        <div>
          <label className="block text-sm text-black/60 mb-1.5">ผู้รับผิดชอบ</label>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-black/60 mb-1.5">วันเริ่ม</label>
            <input type="date" value={form.start_date ?? ''} onChange={(e) => set('start_date', e.target.value)}
              className="w-full bg-black/5 border border-black/15 rounded-lg px-3 py-2.5 text-sm text-[#12181F] focus:outline-none focus:border-cyan-500/60" />
          </div>
          <div>
            <label className="block text-sm text-black/60 mb-1.5">วันสิ้นสุด</label>
