...
export default async function NewActionPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-xl font-bold text-white">เพิ่ม Action Item</h1>
        <p className="text-sm text-white/40 mt-0.5">สร้างรายการที่ต้องดำเนินการ</p>
      </div>
      <ActionForm branches={branches} profile={profile} />
    </div>
  )
}
